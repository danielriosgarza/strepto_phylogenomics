...
def get_typo_dicts(syn_dict):
    ...
    for name in fields_to_change:
        ...
        elif name == 'genome.publication' or name == 'genome.refseq_accessions':
            fc[name] = rv_min
...
def spelling(inputfile, outputfile, fc):
    ...
    fields_more_terms = ["genome.additional_metadata", 'genome.antimicrobial_resistance',
                         'genome.disease' ,'genome.body_sample_site', 'genome.host_health' ]
            ...
            for line in f:
                ...
                for i,name in enumerate(a):
                    ...
                    if i in indexes:
                        ...
                        #look for fields that have several terms
                        if field in fields_more_terms:
                            ...
                            if a[i] == '':
                                ...
                                #look if the item is in the bag of terms and add the syn to temp list terms
                                for item in items:
                                    if item in fc[field]:
                                        c = fc[field][item]
                                        terms.append(c)
                                ...
                                #write syns in alphabetical order to database file
                                f2.write("::".join(terms))
